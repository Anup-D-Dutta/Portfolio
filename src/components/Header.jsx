    ...
    return (
        <div className="font-sans">
            <div className="logo-n flex items-center justify-between fixed top-0 left-0 p-4 bg-[#1d1d1d] shadow w-full z-10 border-white">
                ...
                <div className="hidden lg:flex space-x-12 pr-24">
                    <a href="#about" className="text-white hover:text-red-500 transition duration-300">About</a>
                    <a href="#skills" className="text-white hover:text-red-500 transition duration-300">Skills</a>
                    <a href="#projects" className="text-white hover:text-red-500 transition duration-300">Projects</a>
                    <a href="#contact" className="text-white hover:text-red-500 transition duration-300">Contact</a>
                </div>
